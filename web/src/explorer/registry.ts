...
export const EXPLORER_DOMAINS = [
  ...
  },
  {
    ...
    shortName: "Interface",
    description: "The AVA PWA, pairing, sessions, visual explanations and private remote reach over Tailscale.",
    order: 220,
  },
...
const browserWorkflow: ExplorerWorkflow = {
  ...
  nodes: [
    ...
    {
      id: "browser.persistent-control.open-url",
      capabilityId: "browser.persistent-control",
      parentNodeId: "browser.persistent-control.open",
      name: "Open a known site or exact URL",
      description: "Open a declared site alias or explicit HTTP(S) destination and verify the exact active URL without model planning.",
      kind: "external-action",
      toolName: "chrome_open_url",
      producesEvidence: ["tool-result", "dom-confirmation"],
    },
    {
      id: "browser.persistent-control.youtube-search",
      capabilityId: "browser.persistent-control",
      parentNodeId: "browser.persistent-control.open",
      name: "Search YouTube directly",
      description: "For one literal query, open YouTube's encoded results route and verify the exact search_query parameter.",
      kind: "external-action",
  ...
  edges: [
    ...
    { id: "browser.persistent-control.url-e1", from: "browser.persistent-control.open", to: "browser.persistent-control.open-url", kind: "branch", label: "known site or explicit URL" },
    { id: "browser.persistent-control.url-e2", from: "browser.persistent-control.open-url", to: "browser.persistent-control.report", kind: "verification", label: "exact URL verified" },
    { id: "browser.persistent-control.url-e3", from: "browser.persistent-control.open-url", to: "browser.persistent-control.stop", kind: "stop", label: "redirect or mismatch" },
    { id: "browser.persistent-control.youtube-e1", from: "browser.persistent-control.open", to: "browser.persistent-control.youtube-search", kind: "branch", label: "single YouTube query" },
    { id: "browser.persistent-control.youtube-e2", from: "browser.persistent-control.youtube-search", to: "browser.persistent-control.report", kind: "verification", label: "exact query verified" },
    { id: "browser.persistent-control.youtube-e3", from: "browser.persistent-control.youtube-search", to: "browser.persistent-control.stop", kind: "stop", label: "redirect or mismatch" },
...
const instagramSendWorkflow: ExplorerWorkflow = {
  ...
  description: "Resolve the saved username, enter only through that exact profile, submit exact text and verify it.",
  entryNodeId: "instagram.send-dm.resolve",
  nodes: [
    {
      id: "instagram.send-dm.resolve",
      capabilityId: "people.identity-resolution",
      name: "Resolve recipient",
      description: "Read the people map and resolve a known name or alias to one exact Instagram username; never guess.",
      kind: "decision",
    ...
    },
    {
      ...
      name: "Check session on profile",
      description: "Use the opened profile page to confirm login or identify login, 2FA, challenge, or blank-page state.",
      kind: "verification",
    ...
    },
    {
      ...
      name: "Open saved profile",
      description: "Navigate directly to https://www.instagram.com/<saved-username>/. No inbox or learned-thread route is permitted.",
      kind: "operation",
    ...
    },
    {
      ...
      name: "Verify exact profile",
      description: "Require the final browser URL to contain exactly the saved username before any Message action is allowed.",
      kind: "verification",
      toolName: "instagram_open_chat",
      producesEvidence: ["dom-confirmation", "tool-result"],
    },
    {
      ...
      capabilityId: "instagram.send-dm",
      parentNodeId: "instagram.send-dm.fast-path",
      name: "Click profile Message",
      description: "Click the exact Message action on the verified profile. If it is absent or no thread opens, stop without searching Messages.",
      kind: "operation",
      toolName: "instagram_open_chat",
      producesEvidence: ["dom-confirmation", "tool-result"],
    },
    {
      ...
      parentNodeId: "instagram.send-dm.discover",
      name: "Confirm conversation surface",
      description: "Require either the profile message drawer with its composer or a real /direct/t/<id>/ URL produced by the profile click; retain any observed ID as evidence only.",
      kind: "verification",
      toolName: "instagram_open_chat",
      producesEvidence: ["dom-confirmation", "tool-result"],
    },
  ...
  edges: [
    { id: "instagram.send-dm.e1", from: "instagram.send-dm.resolve", to: "instagram.send-dm.stop", kind: "stop", label: "Username missing or identity ambiguous" },
    { id: "instagram.send-dm.e2", from: "instagram.send-dm.resolve", to: "instagram.send-dm.route", kind: "next", label: "Exact username resolved" },
    { id: "instagram.send-dm.e3", from: "instagram.send-dm.route", to: "instagram.send-dm.stop", kind: "stop", label: "Profile unavailable" },
    { id: "instagram.send-dm.e4", from: "instagram.send-dm.route", to: "instagram.send-dm.session", kind: "verification" },
    { id: "instagram.send-dm.e5", from: "instagram.send-dm.session", to: "instagram.send-dm.stop", kind: "stop", label: "Login, 2FA or challenge required" },
    { id: "instagram.send-dm.e6", from: "instagram.send-dm.session", to: "instagram.send-dm.fast-path", kind: "verification", label: "Authenticated" },
    { id: "instagram.send-dm.e7", from: "instagram.send-dm.fast-path", to: "instagram.send-dm.stop", kind: "stop", label: "URL identity mismatch" },
    { id: "instagram.send-dm.e8", from: "instagram.send-dm.fast-path", to: "instagram.send-dm.discover", kind: "next", label: "Exact profile verified" },
    { id: "instagram.send-dm.e9", from: "instagram.send-dm.discover", to: "instagram.send-dm.stop", kind: "stop", label: "Message action unavailable" },
    { id: "instagram.send-dm.e10", from: "instagram.send-dm.discover", to: "instagram.send-dm.open", kind: "verification" },
    { id: "instagram.send-dm.e11", from: "instagram.send-dm.open", to: "instagram.send-dm.submit", kind: "next" },
    { id: "instagram.send-dm.e12", from: "instagram.send-dm.submit", to: "instagram.send-dm.verify", kind: "verification" },
  ],
};
...
const capabilities: ExplorerCapability[] = [
  ...
  },
  {
    ...
    examples: ["Open AVA Chrome.", "Open GitHub.", "Open https://example.com.", "Open Google and search for AVA.", "Search YouTube for AVA demos.", "Read this page.", "Fill in this form and verify the result."],
    inputs: [
    ...
    runtime: runtime(
      ["chrome_open", "chrome_open_url", "chrome_google_search", "chrome_youtube_search", "chrome_navigate", "chrome_click", "chrome_type", "chrome_press_key", "chrome_snapshot", "chrome_read_page", "chrome_screenshot", "chrome_tabs", "computer_use"],
      [
  ...
  {
    id: "desktop.microsoft-ufo",
    domainId: "desktop",
    name: "Experimental Microsoft UFO",
    shortName: "Microsoft UFO",
    description: "Runs one pinned, approval-gated Microsoft UFO Notepad proof or a separate synthetic counter fixture; it is not general computer use.",
    purpose: "Evaluate genuine Microsoft UFO execution through AVA with a fixed disposable task and independently verified evidence.",
    stability: "experimental",
    definition: {
      implementation: "implemented",
      sourceReferences: [
        source("server/src/ufo/experiment.ts", "UfoExperimentService"),
        source("server/src/ufo/experiment.ts", "MicrosoftUfoRuntimeAdapter"),
        source("server/src/tools/ufo-experiment-mcp.ts", "buildUfoExperimentTools"),
        source("server/src/ufo/runtime-adapter.test.ts", "genuine Microsoft UFO runtime adapter", "test"),
        source("server/src/ufo/experiment.test.ts", "UfoExperimentService", "test"),
        source("server/src/tools/ufo-experiment-mcp.test.ts", "buildUfoExperimentTools", "test"),
        source("docs/features/microsoft-ufo-experiment.md", "Microsoft UFO bounded runtime integration", "documentation"),
      ],
    },
    examples: [
      "Show whether the Microsoft UFO experiment is genuinely available.",
      "Run the fixed disposable Notepad UFO proof after I approve it.",
      "Inspect the synthetic counter fixture without calling it Microsoft UFO.",
    ],
    inputs: [
      { name: "health request", description: "Read-only request for configured mode, dependency and bounded runtime readiness.", required: false },
      { name: "fixed proof request", description: "The genuine runtime accepts only AVA's compiled-in disposable Notepad task; no arbitrary prompt, text, file or application target.", required: false },
      { name: "expected fixture version", description: "Optimistic concurrency guard for synthetic counter actions.", required: false },
    ],
    outputs: [
      { name: "runtime health", description: "Explicit adapter, mode, dependency, approval and limitation evidence." },
      { name: "bounded run record", description: "Sanitised request ID, status, step count and verification summary.", persistent: true },
      { name: "Mission Control trace", description: "One correlated child trace with genuine-versus-synthetic provenance.", persistent: true },
    ],
    dependencies: [
      { targetType: "application", targetId: "windows.notepad", relationship: "depends-on", required: true, description: "The genuine path is compiled to one disposable Notepad fixture." },
      { targetType: "service", targetId: "microsoft.ufo-v3.0.8", relationship: "depends-on", required: true, description: "Requires the exact pinned Microsoft/UFO release and commit plus its isolated Python environment." },
      { targetType: "model", targetId: "openai.ufo-provider", relationship: "depends-on", required: true, description: "The genuine runtime requires configured provider credentials; values are never exposed in Explorer." },
      { targetType: "capability", targetId: "security.risk-policy", relationship: "requires", required: true, description: "Every fixture action and genuine runtime execution remains explicitly approval-gated." },
      { targetType: "capability", targetId: "verification.outcome-evidence", relationship: "verifies-with", required: true, description: "The genuine proof requires an independent Windows UI Automation exact-text check." },
    ],
    readiness: readiness(["defined", "configured", "available", "healthy", "tested"], { recentSuccess: true }),
    verification: verification(
      [
        "The configured adapter and exact runtime dependency pass the authenticated health contract.",
        "A genuine run records at least one Microsoft UFO execution step and exits successfully.",
        "Independent Windows UI Automation reads the exact compiled-in text from the disposable Notepad fixture.",
      ],
      ["health-check", "task-event", "tool-result", "visual-confirmation"],
      [
        "Synthetic counter success verifies only AVA's fixture harness and is never Microsoft UFO success.",
        "The genuine runtime supports only one fixed Notepad proof, not arbitrary computer use.",
        "Provider token and cost usage are not reported by this adapter.",
      ],
    ),
    safety: safety("high", "always", ["Starts the pinned Microsoft UFO runtime.", "Controls only a disposable unsaved Notepad fixture.", "Sends task context and screenshots from the visible desktop to the configured model during an approved genuine run."], {
      sensitiveData: ["Visible desktop content during an approved genuine run", "Provider credential supplied only through the child environment"],
      stopConditions: ["Fail closed when the exact pinned runtime, credentials, interactive desktop or fixed fixture is unavailable.", "Stop on timeout, cancellation, unexpected target, failed independent verification or stale fixture version."],
    }),
    runtime: runtime(
      ["ufo_experiment_status", "ufo_experiment_observe", "ufo_experiment_action", "ufo_runtime_run"],
      [
        { path: "integrations.microsoftUfo.enabled", dimension: "configured", interpretation: "boolean" },
        { path: "integrations.microsoftUfo.available", dimension: "available", interpretation: "boolean" },
        { path: "integrations.microsoftUfo.runtime.dependency", dimension: "healthy", interpretation: "non-null", note: "The runtime adapter interprets available, unavailable and not-checked honestly." },
        { path: "integrations.microsoftUfo.actionsAvailable", dimension: "available", interpretation: "boolean", note: "Action availability does not bypass explicit approval." },
      ],
      ["/api/ufo-experiment/health", "/api/ufo-experiment/requests/:id"],
    ),
    workflow: defineWorkflow(
      "desktop.microsoft-ufo",
      "Bounded Microsoft UFO experiment",
      "Separates truthful health inspection, the synthetic fixture, and one genuine fixed Notepad proof.",
      [
        { key: "request", name: "Inspect or request experiment", description: "AVA receives a health, synthetic fixture or fixed genuine-runtime request.", kind: "request" },
        { key: "health", name: "Read authoritative health", description: "Inspect mode, adapter, exact dependency, isolation, limits and action availability without exposing secrets.", kind: "verification", toolName: "ufo_experiment_status" },
        { key: "surface", name: "Choose truthful surface", description: "Branch between unavailable, synthetic fixture and genuine Microsoft UFO; never silently fall back.", kind: "decision" },
        { key: "observe", name: "Observe synthetic counter", description: "Read a bounded counter fixture. This proves only the fixture harness, not Microsoft UFO.", kind: "operation", toolName: "ufo_experiment_observe" },
        { key: "approve-fixture", name: "Approve synthetic action", description: "Require explicit approval and an expected fixture version before incrementing the counter.", kind: "decision" },
        { key: "advance", name: "Advance synthetic counter", description: "Perform one bounded, version-guarded fixture action.", kind: "external-action", toolName: "ufo_experiment_action" },
        { key: "approve-runtime", name: "Approve genuine runtime", description: "Require explicit approval for the fixed disposable Notepad proof.", kind: "decision" },
        { key: "run", name: "Run fixed Notepad proof", description: "Launch the exact pinned Microsoft UFO runtime with no arbitrary prompt, target, text or file input.", kind: "external-action", toolName: "ufo_runtime_run" },
        { key: "verify", name: "Verify exact visible text", description: "Require Microsoft UFO steps, successful exit and independent Windows UI Automation exact-text evidence.", kind: "verification" },
        { key: "stop", name: "Stop unavailable or unsafe path", description: "Fail closed without executing when configuration, dependency, approval, target or verification is missing.", kind: "stop" },
      ],
      [
        { from: "request", to: "health", kind: "next" },
        { from: "health", to: "surface", kind: "verification" },
        { from: "surface", to: "observe", kind: "branch", label: "Synthetic observe-only" },
        { from: "surface", to: "approve-fixture", kind: "branch", label: "Synthetic action configured" },
        { from: "approve-fixture", to: "advance", kind: "next", label: "Approved and version current" },
        { from: "surface", to: "approve-runtime", kind: "branch", label: "Pinned genuine runtime available" },
        { from: "approve-runtime", to: "run", kind: "next", label: "Approved" },
        { from: "run", to: "verify", kind: "verification" },
        { from: "surface", to: "stop", kind: "stop", label: "Unavailable or disabled" },
        { from: "approve-fixture", to: "stop", kind: "stop", label: "Denied or stale" },
        { from: "approve-runtime", to: "stop", kind: "stop", label: "Denied" },
        { from: "verify", to: "stop", kind: "stop", label: "Contradicted or uncertain" },
      ],
    ),
  },
  {
  ...
  },
  {
    ...
    dependencies: [
      ...
      { targetType: "capability", targetId: "people.identity-resolution", relationship: "uses", required: false, description: "Known people map to authoritative usernames; observed thread IDs are evidence only." },
    ],
  ...
  },
  {
    ...
    shortName: "Send DM",
    description: "Resolves the saved username, verifies its exact profile, enters through Message, sends exact text and verifies its appearance.",
    ...
    verification: verification(
      ["Recipient identity resolves to one saved username without guessing.", "The exact profile URL is verified before its Message action opens a thread.", "The exact message appears in that conversation after submission."],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: "platform identifiers", description: "Verified username, phone or display name, plus thread metadata retained as evidence.", required: false, sensitive: true },
    ],
  ...
  {
    id: "memory.semantic-index",
    domainId: "memory",
    name: "Source-linked research, idea and improvement recall",
    shortName: "Memory index",
    description: "Captures compact research and Idea checkpoints plus committed AVA product improvements, recalls them across chat and voice, and lets Sir correct, pin, supersede or resolve conflicts without rewriting their original evidence.",
    ...
    definition: {
      ...
      sourceReferences: [
        ...
        source("server/src/memory-index/improvement-index.ts", "ImprovementIndexCoordinator"),
        ...
        source("server/src/memory-index/improvement-index.test.ts", "committed improvement indexing", "test"),
      ],
    },
    examples: ["Research durable memory systems.", "Remember this discussion.", "What did we decide about durable research recall?", "What update added Microsoft UFO support?", "Forget that indexed idea."],
    inputs: [
      { name: "selected conversation range", description: "A bounded range of authoritative AVA message IDs for conversation-sourced memory.", required: false, sensitive: true },
      { name: "committed improvement source", description: "An exact reachable AVA Git commit supplied only by boot reconciliation or a successful Self swap.", required: false, sensitive: false },
    ...
    outputs: [
      { name: "source-linked memory", description: "A versioned SQLite checkpoint with immutable lineage, a conversation or committed-improvement fingerprint and replaceable embedding.", persistent: true },
    ...
    dependencies: [
      ...
      { targetType: "capability", targetId: "security.secret-redaction", relationship: "uses", required: true, description: "Content is scrubbed before storage, embedding and display." },
      { targetType: "service", targetId: "openai.embeddings", relationship: "uses", required: false, description: "OpenAI embeddings enable semantic similarity; exact and keyword retrieval remains available without them." },
    ],
    readiness: readiness(["defined", "configured", "available", "healthy", "tested"], { recentSuccess: true }),
    verification: verification(
      ["Automatic conversation capture is offered only after completed research, a meaningfully developed Idea, or a material later Idea change.", "Committed product improvements are reconciled from an exact reachable Git commit; failed, uncommitted, docs-only and test-only work is excluded.", "Material refinements append immutable thread/parent/sequence/type/reason lineage instead of rewriting older checkpoints.", "Capture stores no transcript body and records one exact typed source fingerprint.", "Every returned result rechecks the original conversation or committed improvement before it is marked usable.", "Chat, OpenAI voice and Hume share the same bounded retrieval gate.", "Corrections and governance actions are append-only, version-guarded and replay-idempotent.", "Unresolved conflicts and superseded/history checkpoints are excluded from automatic recall."],
    ...
    safety: safety("low", "never", ["Persists compact personal or project context for later retrieval."], {
      ...
      redactions: ["Secrets are scrubbed before SQLite persistence and before provider embedding calls."],
  ...
  {
    id: "memory.structured-notes",
    domainId: "memory",
    name: "Structured Notes workspace",
    shortName: "Notes",
    description: "Captures general or project-scoped notes in a reusable workspace with project templates, priorities, decisions, documentation and a four-stage board.",
    purpose: "Turn ideas and stable project context into an organised, visible system that AVA and Sir can update together.",
    stability: "beta",
    definition: {
      implementation: "implemented",
      sourceReferences: [
        source("server/src/state/notes.ts", "createNote"),
        source("server/src/routes/notes.ts", "notesRoutes", "route"),
        source("server/src/tools/notes-mcp.ts", "buildNotesTools"),
        source("web/src/notes/NotesScreen.tsx", "NotesScreen"),
        source("server/src/state/notes.test.ts", "structured notes state", "test"),
        source("server/src/routes/notes.test.ts", "notes routes", "test"),
        source("server/src/tools/notes-mcp.test.ts", "notes tools", "test"),
        source("web/src/notes/NotesScreen.test.tsx", "Notes workspace", "test"),
      ],
    },
    examples: ["Put this idea in Notes under AVA Voice.", "Show the decisions for the AVA project.", "Turn this note into a task."],
    inputs: [
      { name: "note content", description: "The idea, requirement, decision, documentation or other context to retain.", required: true, sensitive: true },
      { name: "organisation", description: "Optional project, template section, board stage, tags, links and pinned state.", required: false, sensitive: true },
    ],
    outputs: [
      { name: "versioned note", description: "A structured note with edit history and optimistic version protection.", persistent: true },
      { name: "project note space", description: "An explicit project workspace that can exist before its first note.", persistent: true },
      { name: "promotion lineage", description: "A task prompt or approval-gated self-improvement request linked back to its source note.", persistent: true },
    ],
    dependencies: [
      { targetType: "data-store", targetId: "sqlite.notes", relationship: "writes-to", required: true, description: "Projects, notes, rich details, versions and promotion lineage persist in SQLite." },
      { targetType: "capability", targetId: "self-improvement.pipeline", relationship: "uses", required: false, description: "Explicit improvement promotion enters AVA's existing approval-gated pipeline." },
    ],
    readiness: readiness(["defined", "configured", "available", "healthy", "tested"], { recentSuccess: true }),
    verification: verification(
      ["A captured or edited note can be read back with the intended project, section, stage, content and version.", "A promoted item records its destination identifier without deleting or rewriting the source note."],
      ["api-response", "tool-result", "unit-test", "artifact"],
      ["A saved note proves persistence, not that the content is accurate or still current.", "Starting a task from a note does not itself prove the task completed."],
    ),
    safety: safety("low", "never", ["Persists personal or project context and can explicitly request a separate downstream action."], {
      sensitiveData: ["Personal notes", "Project requirements", "Decisions", "Links and documentation"],
      redactions: ["Raw credentials and secrets must not be captured in Notes."],
      stopConditions: ["Do not silently promote a note into self-improvement.", "Do not represent task promotion as task completion."],
    }),
    runtime: runtime(
  ...
  {
    id: "automation.activepieces",
    domainId: "automation",
    name: "Activepieces deterministic playbooks",
    shortName: "Activepieces",
    description: "Runs pinned playbooks and approval-gated generated one-to-six-step plans on a genuine local Activepieces runtime while AVA retains routing, identity, execution, evidence, verification and memory authority.",
    ...
    definition: {
      ...
      sourceReferences: [
        ...
        source("server/src/automations/generated-playbook-executor.ts", "buildGeneratedPlaybookExecutor"),
        ...
        source("server/scripts/activepieces-system-report-live-smoke.ts", "black-box genuine playbook acceptance", "test"),
    ...
    examples: ["Run AVA's system health report.", "Create AVA's operations brief for the last 24 hours.", "Open Lasha's Instagram chat.", "Repeat this verified browser and Instagram sequence.", "Which Activepieces playbooks are available?"],
    inputs: [{ name: "bounded workflow snapshot", description: "Non-secret aggregate data or an explicitly approved ordered definition containing one to six allowlisted, independently verified steps.", required: true }],
    outputs: [
    ...
    readiness: readiness(["defined", "configured", "available", "healthy", "tested"], { recentSuccess: true }),
    verification: verification(
      ["The response echoes the exact request, workflow and version.", "AVA writes, reads back and SHA-256 verifies the artifact before success.", "Every retained source step has its own independent verification evidence.", "Two distinct verified task receipts are required before a generated candidate is proposed.", "A duplicate request or task observation is idempotent."],
      ["tool-result", "artifact", "task-event", "unit-test"],
      ["Configured endpoint health is reported per workflow and is not execution proof; the black-box smoke requires real completed invocations.", "Generated sequences support direct URL/search and profile-first Instagram open/read only; messages, typing, clicks, shell, file mutation and arbitrary flows are excluded.", "The local source runtime is a pinned experimental integration, not a general arbitrary-flow executor."],
    ),
  ...
  {
    id: "interface.visual-explanations",
    domainId: "interface",
    name: "Progressive visual explanations",
    shortName: "Visual explanations",
    description: "Places versioned, interactive VisualMessages directly beneath AVA's answer, with compact progressive scenes and explicit conversational context actions.",
    purpose: "Let Sir understand and question a system visually without leaving Chat or relying on giant diagrams, external renderers or unsafe generated HTML.",
    stability: "beta",
    definition: {
      implementation: "implemented",
      sourceReferences: [
        source("server/src/visual-explanations/model.ts", "validateVisualExplanation"),
        source("server/src/state/visual-explanations.ts", "createVisualExplanation"),
        source("server/src/routes/visual-explanations.ts", "visualExplanationRoutes", "route"),
        source("server/src/tools/visual-explanations-mcp.ts", "buildVisualExplanationTools"),
        source("web/src/chat/MessageList.tsx", "MessageList"),
        source("web/src/visuals/VisualMessageCard.tsx", "VisualMessageCard"),
        source("web/src/visuals/VisualFlowCanvas.tsx", "VisualFlowCanvas"),
        source("web/src/visuals/render.ts", "buildSceneFlow"),
        source("web/src/visuals/VisualsScreen.tsx", "VisualsScreen"),
        source("server/src/visual-explanations/model.test.ts", "validateVisualExplanation", "test"),
        source("web/src/visuals/VisualExplanationViewer.test.tsx", "VisualMessageCard", "test"),
        source("docs/features/visual-explanations.md", "Visual explanations", "documentation"),
      ],
    },
    examples: ["Show me how this repository is organised.", "Explain how my request moves through AVA.", "Visualise the approval branches in this workflow."],
    inputs: [
      { name: "semantic model", description: "Renderer-neutral elements and relationships with stable explicit IDs. Restricted Mermaid remains a compatible ingest option.", required: true, sensitive: true },
      { name: "storyboard", description: "Versioned scenes referencing semantic element IDs with captions, highlights, transitions and optional interaction cues.", required: true, sensitive: true },
    ],
    outputs: [
      { name: "canonical VisualMessage", description: "Immutable semantic model, storyboard, renderer metadata and accessible fallback stored locally with chat/voice lineage.", persistent: true },
      { name: "inline native walkthrough", description: "A progressive keyboard-accessible presentation directly under AVA's answer, with optional in-app expansion." },
      { name: "SVG or PNG export", description: "A disposable current-scene export generated in the browser and never treated as canonical state." },
    ],
    dependencies: [
      { targetType: "capability", targetId: "conversation.text-turn", relationship: "uses", required: true, description: "AVA creates an exact revision through its tool path and attaches it to the assistant message." },
      { targetType: "capability", targetId: "interface.pwa", relationship: "uses", required: true, description: "Chat renders the native card; Visuals remains an optional workspace." },
      { targetType: "data-store", targetId: "sqlite.visual-explanations", relationship: "writes-to", required: true, description: "Only validated VisualMessage revisions and message references are canonical; rendered artifacts are not stored." },
    ],
    readiness: readiness(["defined", "available", "healthy", "tested"], { recentSuccess: true }),
    verification: verification(
      ["Every relationship and storyboard reference resolves to one declared stable semantic ID.", "The exact immutable revision reloads inline with its assistant message.", "Each scene renders locally from typed React Flow nodes and Dagre positions, or exposes the complete static fallback.", "SVG and PNG exports are generated from the active native scene without changing canonical state."],
      ["api-response", "tool-result", "unit-test", "artifact"],
      ["The v1 semantic model and automatic layout support flowcharts; direct canvas editing is deferred.", "Voice delegated actions do not yet attach visuals to the spoken transcript.", "The visual communicates supplied structure; it does not independently prove the underlying system is accurate."],
    ),
    safety: safety("low", "never", ["Persists a sanitized visual source and may download a disposable SVG or PNG on explicit user action."], {
      sensitiveData: ["Repository structure", "Workflow labels", "Request and project context"],
      redactions: ["Secret-like text is scrubbed before persistence; native labels are React text and renderer payloads are never executed or injected as markup."],
...
const WORKFLOW_BY_CAPABILITY_ID: Readonly<Record<string, ExplorerWorkflow>> = {
  ...
  "desktop.microsoft-ufo": capabilities.find((capability) => capability.id === "desktop.microsoft-ufo")!.workflow!,
  ...
  "instagram.messaging": defineWorkflow(
    ...
    "Resolve a saved username and enter messages only through that exact verified profile.",
    [
      ...
      { key: "resolve-recipient", parent: "messages", capabilityId: "people.identity-resolution", name: "Resolve recipient username", description: "Resolve one saved Instagram username or a handle-like explicit username; a thread ID alone is insufficient.", kind: "decision", toolName: "person_list" },
      { key: "open-chat", parent: "messages", name: "Open through exact profile", description: "Navigate to instagram.com/<username>/, verify the final profile URL, and click its exact Message action. Never search the inbox.", kind: "operation", toolName: "instagram_open_chat", producesEvidence: ["dom-confirmation", "tool-result"] },
  ...
  "people.identity-resolution": defineWorkflow(
    ...
    [
      ...
      { key: "known", parent: "lookup", name: "Use known platform identity", description: "Return the stored username, phone or display name for one match; thread metadata is evidence, not identity.", kind: "result", producesEvidence: ["tool-result"] },
  ...
  "memory.semantic-index": defineWorkflow(
    ...
    [
      ...
      { key: "explain", parent: "verify", name: "Explain why it matched", description: "Return summary, source state, match mode, shared terms and semantic score when available.", kind: "result", producesEvidence: ["tool-result"] },
      { key: "forget", parent: "request", name: "Forget exact version", description: "Soft-delete the selected entry and immediately remove its embedding without deleting the source conversation.", kind: "external-action", toolName: "memory_index_forget", producesEvidence: ["tool-result", "artifact"] },
    ],
    [
      ...
      { from: "open", to: "explain" },
      { from: "verify", to: "explain", label: "verified" },
      { from: "request", to: "forget", kind: "branch", label: "forget" },
    ],
  ),
  "memory.structured-notes": defineWorkflow(
    "memory.structured-notes",
    "Capture, organise and promote a structured note",
    "Keep general and project knowledge visible, versioned and actionable without confusing a saved note with completed work.",
    [
      { key: "request", name: "Understand the note request", description: "Identify whether Sir wants to capture, find, edit, move or promote a note.", kind: "request" },
      { key: "project", parent: "request", name: "Select General or project space", description: "Use General unless Sir names a project; create an explicit project space when requested.", kind: "decision" },
      { key: "section", parent: "project", name: "Choose template section", description: "Route the content to quick capture, pinned priorities, decisions or stable documentation.", kind: "decision" },
      { key: "capture", parent: "section", name: "Capture structured note", description: "Persist content, kind, stage, tags, links and source with a version number.", kind: "external-action", toolName: "notes_capture", producesEvidence: ["tool-result", "artifact"] },
      { key: "update", parent: "section", name: "Edit or move existing note", description: "Apply a version-checked update, including board moves between Ideas, Doing, Review and Done.", kind: "external-action", toolName: "notes_update", producesEvidence: ["tool-result", "artifact"] },
      { key: "verify", parent: "section", name: "Read back intended structure", description: "Confirm the note appears in the correct space, section and board stage with its current version.", kind: "verification", toolName: "notes_search", producesEvidence: ["tool-result"] },
      { key: "promote", parent: "verify", name: "Promote without losing source", description: "Create a prefilled task prompt or queue an explicit approval-gated self-improvement request and retain the note's lineage.", kind: "external-action", toolName: "notes_promote", producesEvidence: ["tool-result", "artifact"] },
      { key: "task", parent: "promote", capabilityId: "orchestration.agent-loop", name: "Open as an AVA task", description: "Start a separate task from the generated prompt; the note remains available as source context.", kind: "result" },
      { key: "improvement", parent: "promote", capabilityId: "self-improvement.pipeline", name: "Request self-improvement", description: "Enter the normal approval-gated improvement pipeline rather than silently modifying AVA.", kind: "result" },
    ],
    [
      { from: "request", to: "project" },
      { from: "project", to: "section" },
      { from: "section", to: "capture", kind: "branch", label: "new note" },
      { from: "section", to: "update", kind: "branch", label: "existing note" },
      { from: "capture", to: "verify", kind: "verification" },
      { from: "update", to: "verify", kind: "verification" },
      { from: "verify", to: "promote", kind: "branch", label: "make actionable" },
      { from: "promote", to: "task", kind: "branch", label: "task" },
      { from: "promote", to: "improvement", kind: "branch", label: "self-improvement" },
    ],
  ),
  ...
  "automation.activepieces": defineWorkflow(
    ...
    [
      ...
      { key: "observe", parent: "request", name: "Observe verified repetition", description: "Compile one-to-six-step browser/Instagram sequences only when every retained source step has independent evidence; replayed task IDs do not count twice.", kind: "operation" },
      ...
      { key: "plan", parent: "approve", name: "Validate approved plan", description: "Activepieces renders the stable step order, per-step argument fingerprints and evidence fingerprint for AVA read-back verification.", kind: "verification", producesEvidence: ["artifact", "task-event"] },
      { key: "execute", parent: "plan", name: "Execute active playbook", description: "Revalidate identities and arguments, run existing AVA tools in order, and stop on the first failed or unverified step.", kind: "external-action", toolName: "automation_run_playbook", producesEvidence: ["tool-result"] },
      ...
      { key: "verify", parent: "request", name: "Verify local artifact", description: "Write atomically, read back and compare SHA-256 before claiming success.", kind: "verification", producesEvidence: ["artifact", "task-event"] },
      { key: "index", parent: "request", capabilityId: "memory.durable", name: "Index verified artifact", description: "Create one source-verified semantic locator backed by the immutable record and file hash.", kind: "result", producesEvidence: ["artifact"] },
      { key: "stop", parent: "request", name: "Stop honestly", description: "Report unavailable, failed, cancelled or timed out without replay or false verification.", kind: "stop", producesEvidence: ["task-event"] },
    ],
    [
      ...
      { from: "delegate", to: "validate" },
      { from: "validate", to: "verify", kind: "verification" },
      { from: "verify", to: "index", kind: "verification" },
      { from: "delegate", to: "stop", kind: "stop", label: "unavailable or failed" },
      { from: "validate", to: "stop", kind: "stop", label: "invalid evidence" },
      { from: "verify", to: "stop", kind: "stop", label: "read-back mismatch" },
    ],
  ),
  ...
  "interface.visual-explanations": defineWorkflow(
    "interface.visual-explanations",
    "Build and present a progressive visual explanation",
    "Keep topology canonical in renderer-neutral stable IDs, attach the exact revision to Chat, and render only the current bounded view.",
    [
      { key: "request", name: "Ask for a visual explanation", description: "Niko asks AVA to map a repository, walk through a request path or explain a branching process.", kind: "request" },
      { key: "topology", parent: "request", name: "Define stable semantics", description: "AVA expresses elements and relationships in a renderer-neutral model with stable explicit IDs.", kind: "operation", toolName: "visual_explanation_create" },
      { key: "storyboard", parent: "topology", name: "Compose progressive scenes", description: "A versioned JSON storyboard references only those IDs and owns captions, bounded highlights, transitions and interaction cues.", kind: "operation" },
      { key: "validate", parent: "topology", name: "Validate IDs and safety", description: "Reject missing or duplicate IDs, oversized scenes, uncovered nodes, active links, HTML, directives and external resource syntax before persistence.", kind: "verification", producesEvidence: ["tool-result", "unit-test"] },
      { key: "persist", parent: "validate", name: "Persist exact revision", description: "Store the sanitized VisualMessage and attach its immutable ID/revision to AVA's assistant message; never store generated HTML, SVG or PNG.", kind: "operation", producesEvidence: ["artifact", "api-response"] },
      { key: "scene", parent: "persist", name: "Render inline scene", description: "Project the selected semantic scene into typed React Flow nodes and edges, use Dagre for a disposable directed layout, and render native React text without executing generated markup.", kind: "operation", producesEvidence: ["visual-confirmation"] },
      { key: "drill", parent: "scene", name: "Navigate or drill down", description: "Move by buttons, scene tabs or keyboard while captions and the accessible text fallback preserve meaning.", kind: "decision" },
      { key: "context", parent: "drill", name: "Ask about selected context", description: "Only an explicit Explain, branch or attach action sends the validated visual ID, revision, scene and selected semantic IDs back to AVA.", kind: "operation" },
      { key: "export", parent: "scene", name: "Export current scene", description: "Generate a disposable browser-local SVG or high-resolution PNG from the active native graph only when explicitly requested.", kind: "result", producesEvidence: ["artifact"] },
      { key: "fallback", parent: "scene", name: "Use static fallback", description: "If rendering is unavailable, expose every scene, node label and highlight as accessible text instead of hiding the explanation.", kind: "result" },
    ],
    [
      { from: "request", to: "topology" },
      { from: "topology", to: "storyboard" },
      { from: "storyboard", to: "validate" },
      { from: "validate", to: "persist", kind: "branch", label: "valid and safe" },
      { from: "persist", to: "scene" },
      { from: "scene", to: "drill" },
      { from: "drill", to: "scene", kind: "retry", label: "next scene" },
      { from: "drill", to: "context", kind: "branch", label: "explicit ask or attach" },
      { from: "scene", to: "export", kind: "branch", label: "explicit export" },
      { from: "scene", to: "fallback", kind: "fallback", label: "renderer unavailable" },
    ],
  ),
