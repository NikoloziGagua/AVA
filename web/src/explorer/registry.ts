...
const capabilities: ExplorerCapability[] = [
  ...
  },
  {
    ...
    examples: ["Run AVA's system health report.", "Is the Activepieces playbook configured?"],
    inputs: [{ name: "bounded readiness snapshot", description: "Non-secret AVA readiness booleans and counts for the pinned report.", required: true }],
    outputs: [
    ...
    runtime: runtime(["automation_system_report", "automation_status"], [], []),
  },
  {
...
const WORKFLOW_BY_CAPABILITY_ID: Readonly<Record<string, ExplorerWorkflow>> = {
  ...
  "automation.activepieces": defineWorkflow(
    ...
    "Run and verify a pinned deterministic playbook",
    "AVA delegates bounded deterministic steps, then independently verifies and indexes the artifact.",
    [
      { key: "request", name: "Request system report", description: "AVA selects only the pinned ava.system-report workflow and stable version.", kind: "request", toolName: "automation_system_report" },
      { key: "snapshot", parent: "request", name: "Build bounded snapshot", description: "Collect readiness booleans and counts without secrets or raw memory content.", kind: "operation" },
